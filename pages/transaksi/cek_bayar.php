            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <a href="index.php?page=cek_bayar_detail&id_siswa=<?=$siswa['id_siswa'];?>" class="btn btn-xs btn-success" role="button" title="Bayar"><i class="fa fa-money"></i> Cek Pembayaran</a>
                  </td>
                </tr>
                <?php } ?>
              </table>
